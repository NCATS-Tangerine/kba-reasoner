...
class ClientConceptsQueryStatus(object):
    ...
    def __init__(self, query_id=None, status=None):
        """
        ClientConceptsQueryStatus - a model defined in Swagger
    ...
    def query_id(self):
        """
        Gets the query_id of this ClientConceptsQueryStatus.
        session identifier of a query previously initiated by /concepts 

        :return: The query_id of this ClientConceptsQueryStatus.
        :rtype: str
        """
    ...
    def query_id(self, query_id):
        ...
        :param query_id: The query_id of this ClientConceptsQueryStatus.
        :type: str
        """
    ...
    def status(self):
        """
        Gets the status of this ClientConceptsQueryStatus.
        array of beacon-specific query status reports 

        :return: The status of this ClientConceptsQueryStatus.
    ...
    def status(self, status):
        ...
        :param status: The status of this ClientConceptsQueryStatus.
