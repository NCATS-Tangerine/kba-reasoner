...
from swagger_server.bio.knowledge.server.model.object import object
...
class Query(Model):
    ...
    """
    def __init__(self, original_question: str=None, restated_question: str=None, message: str=None, known_query_type_id: str=None, query_type_id: str=None, bypass_cache: str=None, asynchronous: str=None, options: str=None, max_results: int=None, page_size: int=None, page_number: int=None, terms: QueryTerms=None, reasoner_ids: List[str]=None, query_plan: List[object]=None):
        """
