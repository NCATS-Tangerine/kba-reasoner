...
class Result(Model):
    ...
    """
    def __init__(self, id: str=None, description: str=None, text: str=None, essence: str=None, row_data: List[str]=None, score: float=None, score_name: str=None, score_direction: str=None, confidence: float=None, result_type: str=None, result_group: int=None, result_group_similarity_score: float=None, reasoner_id: str=None, result_graph: ResultGraph=None):
        """
