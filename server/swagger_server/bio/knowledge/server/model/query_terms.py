...
class QueryTerms(Model):
    ...
    """
    def __init__(self, disease: str=None, protein: str=None, anatomical_entity: str=None, chemical_substance: str=None, metabolite: str=None):
        """
    ...
    def from_dict(cls, dikt) -> 'QueryTerms':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The Query_terms of this QueryTerms.
        :rtype: QueryTerms
        """
